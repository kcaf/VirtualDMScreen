...
*/
    ...
    _saveSnapshot: function() {
      if (this._state === "normal") {
        ...
        this.original_size_height = $(this.element[0]).dialog("option", "height");
        ...
        if ($(this.element[0]).hasClass("gridviewmodel-inc")){
          this.original_size_height = "450px";
          this.original_size_width = "450px";
        }
